...
namespace Sodium
{
  ...
  public static partial class SodiumLibrary
  {
    ...
    //crypto_aead_xchacha20poly1305_ietf_encrypt
    [DllImport("libsodium", CallingConvention = CallingConvention.Cdecl)]
    internal static extern int crypto_aead_xchacha20poly1305_ietf_encrypt(IntPtr cipher, out long cipherLength, IntPtr message, long messageLength, IntPtr additionalData, long additionalDataLength, byte[] nsec, byte[] nonce, byte[] key);
    ...
    //crypto_aead_xchacha20poly1305_ietf_decrypt
    [DllImport("libsodium", CallingConvention = CallingConvention.Cdecl)]
    internal static extern int crypto_aead_xchacha20poly1305_ietf_decrypt(IntPtr message, out long messageLength, byte[] nsec, IntPtr cipher, long cipherLength, IntPtr additionalData, long additionalDataLength, byte[] nonce, byte[] key);
